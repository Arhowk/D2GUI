...
--[[
  ...
  -Additionally, ensure that you have the d2guitest_attachments.xml, d2guitest_attachments.js, and d2guitest_attachments.css files in your panorama content folder to use the GUI.
...
function Attachments:start()
  Convars:RegisterCommand( "attachment_configure", Dynamic_Wrap(Attachments, 'ActivateAttachmentSetup'), "Attachment Setup: attachment_configure <ADDON_NAME>  (e.g. attachment_configure d2guitest)", FCVAR_CHEAT )
